...
class Ui_VariableManagementTab(object):
    def setupUi(self, VariableManagementTab):
        if not VariableManagementTab.objectName():
            VariableManagementTab.setObjectName("VariableManagementTab")
        VariableManagementTab.resize(1280, 720)
        VariableManagementTab.setStyleSheet(
            "QWidget{\n"
        ...
        self.label_allvarialbes_header.setObjectName("label_allvarialbes_header")
        ...
        sizePolicy1.setHeightForWidth(
            self.label_allvarialbes_header.sizePolicy().hasHeightForWidth()
        )
        ...
        self.verticalLayout_7.addWidget(
            self.label_allvarialbes_header, 0, Qt.AlignHCenter
        )
        ...
        self.btn_open_iv.setObjectName("btn_open_iv")
        ...
        self.btn_open_iv.setStyleSheet(
            "QPushButton {\n"
            "    background-color: white;\n"
        ...
        self.btn_open_speakers.setObjectName("btn_open_speakers")
        sizePolicy2.setHeightForWidth(
            self.btn_open_speakers.sizePolicy().hasHeightForWidth()
        )
        self.btn_open_speakers.setSizePolicy(sizePolicy2)
        self.btn_open_speakers.setStyleSheet(
            "QPushButton {\n"
            "    background-color: white;\n"
            "    border: 1px solid white;\n"
            "	color: grey;\n"
        ...
        self.btn_import_metadata.setObjectName("btn_import_metadata")
        ...
        self.btn_export_metadata.setObjectName("btn_export_metadata")
        ...
        self.IV_page.setObjectName("IV_page")
        self.verticalLayout_3 = QVBoxLayout(self.IV_page)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.treeWidget_ivs = QTreeWidget(self.IV_page)
        self.treeWidget_ivs.setObjectName("treeWidget_ivs")
        self.treeWidget_ivs.setStyleSheet(
            "QTreeWidget { \n"
            "	font-size: 14pt; \n"
            "}\n"
            "\n"
        ...
        self.widget_iv_addedit_container.setObjectName("widget_iv_addedit_container")
        ...
        self.btn_add_iv.setObjectName("btn_add_iv")
        ...
        self.btn_edit_ivs.setObjectName("btn_edit_ivs")
        sizePolicy3.setHeightForWidth(
            self.btn_edit_ivs.sizePolicy().hasHeightForWidth()
        )
        self.btn_edit_ivs.setSizePolicy(sizePolicy3)
        self.btn_edit_ivs.setFont(font)
        self.btn_edit_ivs.setStyleSheet(
            "QPushButton {\n"
            "	min-height: 50px;\n"
            "	max-height:50px;\n"
            "	min-width: 150px;\n"
        ...
        self.verticalLayout_3.addWidget(
            self.widget_iv_addedit_container, 0, Qt.AlignLeft
        )
        ...
        self.widget_dvgroup_addnewdvs.setObjectName("widget_dvgroup_addnewdvs")
        ...
        sizePolicy4.setHeightForWidth(
            self.widget_dvgroup_addnewdvs.sizePolicy().hasHeightForWidth()
        )
        ...
        self.treeWidget_dvs.setObjectName("treeWidget_dvs")
        self.treeWidget_dvs.setMinimumSize(QSize(320, 0))
        self.treeWidget_dvs.setStyleSheet(
            "QTreeWidget { \n"
            "	font-size: 14pt; \n"
            "}\n"
            "\n"
        ...
        self.widget_dv_addedit_container.setObjectName("widget_dv_addedit_container")
        ...
        self.btn_add_dv.setObjectName("btn_add_dv")
        ...
        self.btn_edit_dvs.setObjectName("btn_edit_dvs")
        ...
        self.widget_dvgroup_table.setObjectName("widget_dvgroup_table")
        ...
        sizePolicy5.setHeightForWidth(
            self.widget_dvgroup_table.sizePolicy().hasHeightForWidth()
        )
        ...
        self.widget_dvdetectionheadercontainer.setObjectName(
            "widget_dvdetectionheadercontainer"
        )
        ...
        icon2 = QIcon()
        icon2.addFile(":/images/images/Help_Icon.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.tableWidget_detectedinformation.setHorizontalHeaderItem(
        ...
        self.tableWidget_detectedinformation.setObjectName(
            "tableWidget_detectedinformation"
        )
        ...
        sizePolicy7.setHeightForWidth(
            self.tableWidget_detectedinformation.sizePolicy().hasHeightForWidth()
        )
        ...
        self.tableWidget_detectedinformation.setStyleSheet("")
        self.tableWidget_detectedinformation.setHorizontalScrollBarPolicy(
            Qt.ScrollBarAsNeeded
        )
        self.tableWidget_detectedinformation.setSizeAdjustPolicy(
            QAbstractScrollArea.AdjustIgnored
        )
        self.tableWidget_detectedinformation.setEditTriggers(
            QAbstractItemView.NoEditTriggers
        )
        self.tableWidget_detectedinformation.setRowCount(0)
        self.tableWidget_detectedinformation.horizontalHeader().setDefaultSectionSize(
            160
        )
        self.tableWidget_detectedinformation.horizontalHeader().setStretchLastSection(
            True
        )
        ...
        self.label_corpuswaschanged.setObjectName("label_corpuswaschanged")
        ...
        self.label_detectednewvariants.setObjectName("label_detectednewvariants")
        ...
        self.Speaker_page.setObjectName("Speaker_page")
        self.verticalLayout_5 = QVBoxLayout(self.Speaker_page)
        self.verticalLayout_5.setObjectName("verticalLayout_5")
        self.treeWidget_speakers = QTreeWidget(self.Speaker_page)
        self.treeWidget_speakers.setObjectName("treeWidget_speakers")
        self.treeWidget_speakers.setStyleSheet(
            "QTreeWidget { \n"
            "	font-size: 14pt; \n"
            "}\n"
            "\n"
        ...
        self.widget_sp_addedit_container.setObjectName("widget_sp_addedit_container")
        ...
        self.btn_add_speaker.setObjectName("btn_add_speaker")
        ...
        self.btn_edit_speakers.setObjectName("btn_edit_speakers")
        self.btn_edit_speakers.setFont(font)
        self.btn_edit_speakers.setStyleSheet(
            "QPushButton {\n"
            "	min-height: 50px;\n"
            "	max-height:50px;\n"
            "	min-width: 150px;\n"
        ...
        self.verticalLayout_5.addWidget(
            self.widget_sp_addedit_container, 0, Qt.AlignLeft
        )
        ...
        self.widget_metadatamanag_savecancel.setObjectName(
            "widget_metadatamanag_savecancel"
        )
        ...
        sizePolicy9.setHeightForWidth(
            self.widget_metadatamanag_savecancel.sizePolicy().hasHeightForWidth()
        )
    ...
    def retranslateUi(self, VariableManagementTab):
        self.label_allvarialbes_header.setText(
            QCoreApplication.translate("VariableManagementTab", "All Variables", None)
        )
        self.btn_open_iv.setText(
            QCoreApplication.translate(
                "VariableManagementTab", "Independent Variables (IV)", None
            )
        )
        self.btn_open_dv.setText(
            QCoreApplication.translate(
                "VariableManagementTab", "Dependent Variables (DV)", None
            )
        )
        self.btn_open_speakers.setText(
            QCoreApplication.translate("VariableManagementTab", "Speakers", None)
        )
        self.btn_import_metadata.setText(
            QCoreApplication.translate(
                "VariableManagementTab", "Import Metadata\n from file", None
            )
        )
        self.btn_export_metadata.setText(
            QCoreApplication.translate(
                "VariableManagementTab", "Export Metadata\n from file", None
            )
        )
        ...
        self.btn_add_iv.setText(
            QCoreApplication.translate("VariableManagementTab", "Add IV", None)
        )
        self.btn_edit_ivs.setText(
            QCoreApplication.translate("VariableManagementTab", "Edit IVs", None)
        )
        ...
        self.btn_add_dv.setText(
            QCoreApplication.translate("VariableManagementTab", "Add DVs", None)
        )
        self.btn_edit_dvs.setText(
            QCoreApplication.translate("VariableManagementTab", "Edit DVs", None)
        )
        self.label_detectedvariants.setText(
            QCoreApplication.translate(
                "VariableManagementTab", "Detected DV-Variants", None
            )
        )
        self.btn_help.setText(
            QCoreApplication.translate("VariableManagementTab", "Help...", None)
        )
        self.checkBox_unassociated_dvs.setText(
            QCoreApplication.translate(
                "VariableManagementTab",
                "Only show Variants that are not associated to a DV yet?",
                None,
            )
        )
        ___qtablewidgetitem = self.tableWidget_detectedinformation.horizontalHeaderItem(
            0
        )
        ___qtablewidgetitem.setText(
            QCoreApplication.translate(
                "VariableManagementTab", "Detected Variant", None
            )
        )
        ___qtablewidgetitem1 = (
            self.tableWidget_detectedinformation.horizontalHeaderItem(1)
        )
        ___qtablewidgetitem1.setText(
            QCoreApplication.translate("VariableManagementTab", "Occurences", None)
        )
        ___qtablewidgetitem2 = (
            self.tableWidget_detectedinformation.horizontalHeaderItem(2)
        )
        ___qtablewidgetitem2.setText(
            QCoreApplication.translate("VariableManagementTab", "Associated DV", None)
        )
        ___qtablewidgetitem3 = (
            self.tableWidget_detectedinformation.horizontalHeaderItem(3)
        )
        ___qtablewidgetitem3.setText(
            QCoreApplication.translate("VariableManagementTab", "Color", None)
        )
        self.label_corpuswaschanged.setText(
            QCoreApplication.translate(
                "VariableManagementTab",
                "The corpus was changed since the last detection of DV-Variants! Do you wish to automatically detect and extract them again?",
                None,
            )
        )
        self.btn_detectvariants.setText(
            QCoreApplication.translate(
                "VariableManagementTab",
                "Extract DV-Variants from corpus annotations",
                None,
            )
        )
        self.label_detectednewvariants.setText(
            QCoreApplication.translate(
                "VariableManagementTab", "Detected XY new variables!", None
            )
        )
        ___qtreewidgetitem2 = self.treeWidget_speakers.headerItem()
        ___qtreewidgetitem2.setText(
            0, QCoreApplication.translate("VariableManagementTab", "Speakers", None)
        )
        self.btn_add_speaker.setText(
            QCoreApplication.translate("VariableManagementTab", "Add Speakers", None)
        )
        self.btn_edit_speakers.setText(
            QCoreApplication.translate("VariableManagementTab", "Edit Speakers", None)
        )
        self.btn_save_changes.setText(
            QCoreApplication.translate("VariableManagementTab", "Save", None)
        )
        pass
