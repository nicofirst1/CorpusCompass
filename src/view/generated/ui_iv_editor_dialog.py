...
class Ui_IVEditorDialog(object):
    def setupUi(self, IVEditorDialog):
        if not IVEditorDialog.objectName():
            IVEditorDialog.setObjectName("IVEditorDialog")
        ...
        self.comboBox_selectiv.setObjectName("comboBox_selectiv")
        self.comboBox_selectiv.setMinimumSize(QSize(119, 25))
        self.comboBox_selectiv.setStyleSheet(
            "QComboBox {\n"
        ...
        self.btn_removevalue.setObjectName("btn_removevalue")
        ...
        self.tableWidget_storedvalues.setObjectName("tableWidget_storedvalues")
        self.tableWidget_storedvalues.setStyleSheet(
        ...
        self.tableWidget_storedvalues.setHorizontalScrollBarPolicy(
        ...
        self.lineEdit_valueinput.setObjectName("lineEdit_valueinput")
        ...
        self.label_ivname.setObjectName("label_ivname")
        ...
        sizePolicy2.setHeightForWidth(
            self.label_ivname.sizePolicy().hasHeightForWidth()
        )
        ...
        icon2 = QIcon()
        icon2.addFile(":/images/images/Plus_Icon.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.label_storedvals.setObjectName("label_storedvals")
        ...
        self.label_valuename.setObjectName("label_valuename")
        sizePolicy2.setHeightForWidth(
            self.label_valuename.sizePolicy().hasHeightForWidth()
        )
        ...
        self.label_valueinputwarning.setObjectName("label_valueinputwarning")
        font2 = QFont()
        font2.setPointSize(10)
        font2.setBold(True)
        self.label_valueinputwarning.setFont(font2)
        self.label_valueinputwarning.setStyleSheet("QLabel{color:red;}")

        self.gridLayout.addWidget(
            self.label_valueinputwarning, 7, 1, 1, 1, Qt.AlignRight
        )
        ...
        self.gridLayout.addWidget(
            self.label_variableinputwarning, 4, 1, 1, 1, Qt.AlignRight
        )
    ...
    def retranslateUi(self, IVEditorDialog):
        IVEditorDialog.setWindowTitle(
            QCoreApplication.translate("IVEditorDialog", "Dialog", None)
        )
        self.comboBox_selectiv.setCurrentText("")
        self.comboBox_selectiv.setPlaceholderText(
            QCoreApplication.translate(
                "IVEditorDialog", "Select Independent Variable...", None
            )
        )
        self.btn_removevalue.setText(
            QCoreApplication.translate("IVEditorDialog", "Remove selected", None)
        )
        ___qtablewidgetitem = self.tableWidget_storedvalues.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(
            QCoreApplication.translate("IVEditorDialog", "Delete", None)
        )
        ___qtablewidgetitem1 = self.tableWidget_storedvalues.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(
            QCoreApplication.translate("IVEditorDialog", "IV-Value", None)
        )
        self.lineEdit_nameinput.setPlaceholderText(
            QCoreApplication.translate("IVEditorDialog", "Select IV above...", None)
        )
        self.lineEdit_valueinput.setPlaceholderText(
            QCoreApplication.translate(
                "IVEditorDialog", 'IV-Value ("Young", "Old", ...)', None
            )
        )
        ...
        self.label_header.setText(
            QCoreApplication.translate(
                "IVEditorDialog", "Independent Variable - Editor", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.btn_addvalue.setToolTip(
            QCoreApplication.translate(
                "IVEditorDialog",
                "<html><head/><body><p>Add input value to current IV</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.btn_addvalue.setText("")
        self.label_storedvals.setText(
            QCoreApplication.translate(
                "IVEditorDialog", "Current values for selected IV:", None
            )
        )
        self.label_valuename.setText(
            QCoreApplication.translate("IVEditorDialog", "Add value:", None)
        )
        self.label_ivselect.setText(
            QCoreApplication.translate(
                "IVEditorDialog", "Select Independent Variable to edit:", None
            )
        )
