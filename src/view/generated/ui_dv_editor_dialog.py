...
"}")
        icon1 = QIcon()
        icon1.addFile(u":/images/images/checked_icon.png", QSize(), QIcon.Normal, QIcon.Off)
...
"")
        ...
        self.tableWidget_dialog_dvaddvariants.horizontalHeader().setProperty("showSortIndicator", True)
