...
class Ui_SettingsTab(object):
    def setupUi(self, SettingsTab):
        ...
        self.widge_settingscontents.setObjectName("widge_settingscontents")
        ...
        sizePolicy.setHeightForWidth(
            self.label_settingstitle.sizePolicy().hasHeightForWidth()
        )
        ...
        self.gridLayout_2.addWidget(
            self.widge_settingscontents, 0, 0, 1, 1, Qt.AlignTop
        )
    ...
    def retranslateUi(self, SettingsTab):
        self.btn_back.setText(
            QCoreApplication.translate("SettingsTab", "<-- Back to home", None)
        )
        self.label_settingstitle.setText(
            QCoreApplication.translate("SettingsTab", "Settings", None)
        )
        self.label.setText(
            QCoreApplication.translate(
                "SettingsTab",
                "TODO: Specify all settings after implementation is mostly finished (otherwise exact settings are unclear as data/structure/... is unclear)",
                None,
            )
        )
        self.groupBox.setTitle(
            QCoreApplication.translate("SettingsTab", "Settings1", None)
        )
        self.checkBox.setText(
            QCoreApplication.translate("SettingsTab", "CheckBox", None)
        )
        ...
        self.groupBox_2.setTitle(
            QCoreApplication.translate("SettingsTab", "Settings2", None)
        )
