...
"}")
        icon = QIcon()
        icon.addFile(u":/images/images/Help_Icon.svg", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        icon1 = QIcon()
        icon1.addFile(u":/images/images/exit_icon.png", QSize(), QIcon.Normal, QIcon.Off)
...
"")
        icon2 = QIcon()
        icon2.addFile(u":/images/images/settings_symbol.png", QSize(), QIcon.Normal, QIcon.Off)
