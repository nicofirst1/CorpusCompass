...
"}")
        icon1 = QIcon()
        icon1.addFile(u":/images/images/open_icon_white.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        icon2 = QIcon()
        icon2.addFile(u":/images/images/import_icon_white.png", QSize(), QIcon.Normal, QIcon.Off)
