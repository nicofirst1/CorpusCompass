...
"")
        ...
        icon1 = QIcon()
        icon1.addFile(u":/images/images/Plus_Icon.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/images/images/edit_icon_white.png", QSize(), QIcon.Normal, QIcon.Off)
