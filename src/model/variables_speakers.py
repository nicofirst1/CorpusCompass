...
class VariableValue():
    ...
    """
    def __init__(self, name: str,  parent: Type["Variable"] = None, speakers: list = None, color: str = None) -> None:
        self.parent = parent
        self.name = name
...
class Variable():
    ...
    def add_variable_value(self, variable_value: str | Type[VariableValue]) -> bool:
        ...
        variable_value = variable_value if type(variable_value) == VariableValue else VariableValue(name)
        variable_value.set_parent(self)
        
        # Add the variable value to the variable
        self.variable_values[name] = variable_value
    
    def add_variable_values(self, variable_values: List[str | Type[VariableValue]]) -> None:
    ...
    def remove_variable_value(self, variable_value: str | Type[VariableValue], remove_speaker_reference: bool = True) -> bool:
    ...
    def to_dict(variables: List["Variable"]) -> dict:
        ...
        for variable in variables:
            ...
            for variable_value in variable.get_variable_values():
                ...
                variable_value_data["Speakers"] = [str(speaker) for speaker in variable_value.get_speakers()]
...
class Speaker():
    ...
    assigned to him.
    """
    def __init__(self, name: str, iv_values: List[VariableValue] = None, color: str = None) -> None:
        self.name = name
