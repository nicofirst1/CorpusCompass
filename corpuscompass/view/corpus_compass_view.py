...
from corpuscompass.view.dialogs import (
    ...
    AnnotationFormatEditorDialog,
    AnnotationHelpDialog,
    AnnotationRemovalDialog,
    CreateProjectDialog,
...
from corpuscompass.view.dialogs.generic_warining_dialog import GenericWarningDialog
