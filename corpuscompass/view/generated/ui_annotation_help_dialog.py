...
class Ui_AnnotationHelpDialog(object):
    def setupUi(self, AnnotationHelpDialog):
        if not AnnotationHelpDialog.objectName():
            AnnotationHelpDialog.setObjectName("AnnotationHelpDialog")
        ...
        self.label_symoblbased.setObjectName("label_symoblbased")
        font1 = QFont()
        ...
        self.label_colorbased.setObjectName("label_colorbased")
    ...
    def retranslateUi(self, AnnotationHelpDialog):
        AnnotationHelpDialog.setWindowTitle(
            QCoreApplication.translate("AnnotationHelpDialog", "Dialog", None)
        )
        self.label_header.setText(
            QCoreApplication.translate(
                "AnnotationHelpDialog", "How to specify an annotation format?", None
            )
        )
        self.label_symoblbased.setText(
            QCoreApplication.translate(
                "AnnotationHelpDialog", "Information on symbol-based annotation", None
            )
        )
        self.label_2.setText(
            QCoreApplication.translate(
                ...
                "\n"
                'Symbol-based annotation involves the identification and tagging of words or tokens within a corpus using symbols to highlight elements deemed significant for analysis. Annotations detectable with CorpusCompass can be tailored through the specification of an annotation format, enabling the recognition of each user\'s unique annotation style. However, there are specific foundational elements that CorpusCompass expects to find within individual annotations. Each annotation needs to refer to and include a word (="token") in the corpus, as well as a Dependent-Variable-Variant (="Identifier"), which can be surrounded by an arbitrary number of other keyboard symbols.',
                None,
            )
        )
        self.label_colorbased.setText(
            QCoreApplication.translate(
                "AnnotationHelpDialog", "Information on color-based annotation", None
            )
        )
        self.label_3.setText(
            QCoreApplication.translate(
                "AnnotationHelpDialog",
                "Coming soon... (detecting words that are annotation with colors in Microsoft Word-files automatically)",
                None,
            )
        )
