...
################################################################################
## Form generated from reading UI file 'speaker_format_tab.ui'
##
...
class Ui_SpeakerIdTab(object):
    def setupUi(self, SpeakerIdTab):
        if not SpeakerIdTab.objectName():
            SpeakerIdTab.setObjectName(u"SpeakerIdTab")
        ...
        SpeakerIdTab.setStyleSheet(u"QWidget{\n"
...
"	min-height: 40px;\n"
"	border-style: solid;\n"
"	border-color: rgb(242, 180, 130);\n"
"	border-width: 2px;\n"
"	border-radius: 10px;\n"
"}\n"
"\n"
"QPushButton:pressed {\n"
"	background-color:rgb(162, 81, 17) ;\n"
...
"}")
        ...
        self.label_sp_h.setObjectName(u"label_sp_h")
        ...
        self.label_sp_description_2.setObjectName(u"label_sp_description_2")
        ...
        self.label_sp_subheader.setObjectName(u"label_sp_subheader")
        sizePolicy3 = QSizePolicy(QSizePolicy.Policy.Ignored, QSizePolicy.Policy.Maximum)
        sizePolicy3.setHorizontalStretch(0)
        sizePolicy3.setVerticalStretch(0)
        sizePolicy3.setHeightForWidth(self.label_sp_subheader.sizePolicy().hasHeightForWidth())
        ...
        self.radbtn_sp_flex.setObjectName(u"radbtn_sp_flex")
        ...
        sizePolicy4.setHeightForWidth(self.radbtn_sp_flex.sizePolicy().hasHeightForWidth())
        ...
        self.label_sp_helppraat.setObjectName(u"label_sp_helppraat")
        ...
        sizePolicy5.setHeightForWidth(self.label_sp_helppraat.sizePolicy().hasHeightForWidth())
        self.label_sp_helppraat.setSizePolicy(sizePolicy5)
        self.label_sp_helppraat.setPixmap(QPixmap(u":/images/images/Help_Icon.svg"))

        self.gridLayout.addWidget(self.label_sp_helppraat, 3, 2, 1, 1)

        self.radbtn_sp_elan = QRadioButton(self.widget_4)
        self.radbtn_sp_elan.setObjectName(u"radbtn_sp_elan")
        self.radbtn_sp_elan.setEnabled(False)
        sizePolicy4.setHeightForWidth(self.radbtn_sp_elan.sizePolicy().hasHeightForWidth())
        ...
        self.label_sp_helpstandard.setObjectName(u"label_sp_helpstandard")
        sizePolicy5.setHeightForWidth(self.label_sp_helpstandard.sizePolicy().hasHeightForWidth())
        self.label_sp_helpstandard.setSizePolicy(sizePolicy5)
        self.label_sp_helpstandard.setPixmap(QPixmap(u":/images/images/Help_Icon.svg"))

        self.gridLayout.addWidget(self.label_sp_helpstandard, 1, 2, 1, 2)

        self.label_sp_helpflex = QLabel(self.widget_4)
        self.label_sp_helpflex.setObjectName(u"label_sp_helpflex")
        self.label_sp_helpflex.setEnabled(False)
        sizePolicy5.setHeightForWidth(self.label_sp_helpflex.sizePolicy().hasHeightForWidth())
        self.label_sp_helpflex.setSizePolicy(sizePolicy5)
        self.label_sp_helpflex.setPixmap(QPixmap(u":/images/images/Help_Icon.svg"))

        self.gridLayout.addWidget(self.label_sp_helpflex, 5, 2, 1, 1)

        self.label_sp_helpelan = QLabel(self.widget_4)
        self.label_sp_helpelan.setObjectName(u"label_sp_helpelan")
        self.label_sp_helpelan.setEnabled(False)
        sizePolicy5.setHeightForWidth(self.label_sp_helpelan.sizePolicy().hasHeightForWidth())
        self.label_sp_helpelan.setSizePolicy(sizePolicy5)
        self.label_sp_helpelan.setPixmap(QPixmap(u":/images/images/Help_Icon.svg"))

        self.gridLayout.addWidget(self.label_sp_helpelan, 4, 2, 1, 1)

        self.radbtn_sp_standard = QRadioButton(self.widget_4)
        self.radbtn_sp_standard.setObjectName(u"radbtn_sp_standard")
        sizePolicy4.setHeightForWidth(self.radbtn_sp_standard.sizePolicy().hasHeightForWidth())
        ...
        self.radbtn_sp_praat.setObjectName(u"radbtn_sp_praat")
        self.radbtn_sp_praat.setEnabled(False)
        sizePolicy4.setHeightForWidth(self.radbtn_sp_praat.sizePolicy().hasHeightForWidth())
        ...
        self.widget_sp_reactivefeedbackcontents.setObjectName(u"widget_sp_reactivefeedbackcontents")
...
"")
        ...
        self.btn_expand_speakerinfo = QPushButton(self.widget_sp_reactivefeedbackcontents)
        self.btn_expand_speakerinfo.setObjectName(u"btn_expand_speakerinfo")
...
"")
        ...
        self.tableWidget_distinctspeakers.setEditTriggers(QAbstractItemView.NoEditTriggers)
        self.tableWidget_distinctspeakers.setSelectionMode(QAbstractItemView.NoSelection)
        ...
        self.tableWidget_unassignedwords = QTableWidget(self.widget_sp_reactivefeedbackcontents)
        ...
        self.tableWidget_unassignedwords.setEditTriggers(QAbstractItemView.NoEditTriggers)
        self.tableWidget_unassignedwords.setSelectionMode(QAbstractItemView.NoSelection)
        self.tableWidget_unassignedwords.setSelectionBehavior(QAbstractItemView.SelectItems)
        ...
        self.widget_sp_savebuttoncontainer.setObjectName(u"widget_sp_savebuttoncontainer")
...
"}")
        ...
        self.btn_sp_cancel.setStyleSheet(u"QPushButton {\n"
"	color: black;\n"
"	background-color: white;\n"
"	border-style: solid;\n"
"	border-color: black;\n"
...
"}")
        ...
        self.gridLayout_7.addWidget(self.widget_sp_savebuttoncontainer, 1, 0, 1, 1, Qt.AlignBottom)
    ...
    def retranslateUi(self, SpeakerIdTab):
        self.label_sp_h.setText(QCoreApplication.translate("SpeakerIdTab", u"Speaker identification", None))
        self.label_sp_description_2.setText(QCoreApplication.translate("SpeakerIdTab", u"CorpusCompass can only process documents that have a clear and consistent format of indicating which text is spoken by which speaker. This requires a consistent transcription format. You can see examples and select your used format below, on which the menu on the right will provide feedback. If no format applies to your corpus, we suggest you to adapt your corpus format!", None))
        self.label_sp_subheader.setText(QCoreApplication.translate("SpeakerIdTab", u"Specify your transcription format so that CorpusCompass can detect and identify all speakers in your corpus and associate them to their spoken text!", None))
        self.radbtn_sp_flex.setText(QCoreApplication.translate("SpeakerIdTab", u"Flex", None))
...
"for selected format", None))
        ...
        self.btn_expand_speakerinfo.setText(QCoreApplication.translate("SpeakerIdTab", u"\u25b6", None))
        self.label_8.setText(QCoreApplication.translate("SpeakerIdTab", u"Unassigned words:", None))
        self.label_distinctspeakercount.setText(QCoreApplication.translate("SpeakerIdTab", u"12", None))
        self.label_unassignedwordcount.setText(QCoreApplication.translate("SpeakerIdTab", u"292", None))
        self.label_9.setText(QCoreApplication.translate("SpeakerIdTab", u"Distinct speakers:", None))
        ___qtablewidgetitem = self.tableWidget_distinctspeakers.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("SpeakerIdTab", u"Speaker", None));
        ___qtablewidgetitem1 = self.tableWidget_distinctspeakers.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("SpeakerIdTab", u"in Files", None));
        ___qtablewidgetitem2 = self.tableWidget_unassignedwords.horizontalHeaderItem(0)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("SpeakerIdTab", u"File", None));
        ___qtablewidgetitem3 = self.tableWidget_unassignedwords.horizontalHeaderItem(1)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("SpeakerIdTab", u"Amount", None));
        self.btn_sp_save.setText(QCoreApplication.translate("SpeakerIdTab", u"Save", None))
        self.btn_sp_cancel.setText(QCoreApplication.translate("SpeakerIdTab", u"Cancel", None))
        pass
    # retranslateUi
