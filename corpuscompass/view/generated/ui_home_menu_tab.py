...
################################################################################
## Form generated from reading UI file 'home_menu_tab.ui'
##
...
class Ui_HomeMenuTab(object):
    def setupUi(self, HomeMenuTab):
        if not HomeMenuTab.objectName():
            HomeMenuTab.setObjectName(u"HomeMenuTab")
        HomeMenuTab.resize(1280, 720)
        HomeMenuTab.setStyleSheet(u"QWidget{\n"
...
"}")
        ...
        self.widget_analysebuttoncontainer.setObjectName(u"widget_analysebuttoncontainer")
        ...
        self.label_missingforanalysis.setObjectName(u"label_missingforanalysis")
        font = QFont()
        font.setPointSize(10)
        font.setBold(True)
        self.label_missingforanalysis.setFont(font)
        self.label_missingforanalysis.setStyleSheet(u"QLabel{color: red;}")
        ...
        self.btn_home_analysecorpus.setObjectName(u"btn_home_analysecorpus")
        self.btn_home_analysecorpus.setEnabled(True)
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btn_home_analysecorpus.sizePolicy().hasHeightForWidth())
...
"}")
        ...
        self.gridLayout_2.addWidget(self.widget_analysebuttoncontainer, 2, 1, 1, 1, Qt.AlignBottom)

        self.verticalWidget_contents = QWidget(HomeMenuTab)
        self.verticalWidget_contents.setObjectName(u"verticalWidget_contents")
        ...
        self.proj_name_label.setObjectName(u"proj_name_label")
        sizePolicy1 = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Preferred)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.proj_name_label.sizePolicy().hasHeightForWidth())
        ...
        self.btn_projectinformation.setObjectName(u"btn_projectinformation")
        font2 = QFont()
        font2.setPointSize(11)
        font2.setBold(False)
        self.btn_projectinformation.setFont(font2)
        self.btn_projectinformation.setStyleSheet(u"QPushButton {\n"
"    background-color: white;\n"
...
"}")
        icon = QIcon()
        icon.addFile(u":/images/images/Help_Icon.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.verticalWidget_buttons.setObjectName(u"verticalWidget_buttons")
        self.verticalWidget_buttons.setMinimumSize(QSize(600, 0))
        self.verticalWidget_buttons.setStyleSheet(u"QPushButton {\n"
"	color: black;\n"
"    min-width: 150px;\n"
"	min-height: 100px;\n"
"	border-style: solid;\n"
...
"}")
        ...
        self.scrollArea_buttons.setObjectName(u"scrollArea_buttons")
        sizePolicy2 = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Expanding)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.scrollArea_buttons.sizePolicy().hasHeightForWidth())
        self.scrollArea_buttons.setSizePolicy(sizePolicy2)
        self.scrollArea_buttons.setStyleSheet(u"QScrollBar:vertical {\n"
...
"        }")
        ...
        self.label_home_homeimage.setObjectName(u"label_home_homeimage")
        sizePolicy3 = QSizePolicy(QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Minimum)
        sizePolicy3.setHorizontalStretch(0)
        sizePolicy3.setVerticalStretch(0)
        sizePolicy3.setHeightForWidth(self.label_home_homeimage.sizePolicy().hasHeightForWidth())
        self.label_home_homeimage.setSizePolicy(sizePolicy3)
        self.label_home_homeimage.setPixmap(QPixmap(u":/images/images/Home_Icon.svg"))
        ...
        self.label_home_maintitle.setObjectName(u"label_home_maintitle")
        sizePolicy4 = QSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Preferred)
        sizePolicy4.setHorizontalStretch(0)
        sizePolicy4.setVerticalStretch(0)
        sizePolicy4.setHeightForWidth(self.label_home_maintitle.sizePolicy().hasHeightForWidth())
        ...
        self.widget_settingsandclose_container = QWidget(self.scrollAreaWidgetContents_3)
        self.widget_settingsandclose_container.setObjectName(u"widget_settingsandclose_container")
        sizePolicy5 = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Maximum)
        sizePolicy5.setHorizontalStretch(0)
        sizePolicy5.setVerticalStretch(0)
        sizePolicy5.setHeightForWidth(self.widget_settingsandclose_container.sizePolicy().hasHeightForWidth())
...
"}")
        icon1 = QIcon()
        icon1.addFile(u":/images/images/exit_icon.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"")
        icon2 = QIcon()
        icon2.addFile(u":/images/images/settings_symbol.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.horizontalLayout_2.addWidget(self.widget_settingsandclose_container, 0, Qt.AlignRight)


        self.verticalLayout_5.addLayout(self.horizontalLayout_2)

        self.btn_home_managecorpus_sect = QPushButton(self.scrollAreaWidgetContents_3)
        self.btn_home_managecorpus_sect.setObjectName(u"btn_home_managecorpus_sect")
        ...
        sizePolicy7.setHeightForWidth(self.btn_home_managecorpus_sect.sizePolicy().hasHeightForWidth())
...
"}")
        ...
        self.btn_home_speaker_sect.setObjectName(u"btn_home_speaker_sect")
        self.btn_home_speaker_sect.setEnabled(True)
        sizePolicy7.setHeightForWidth(self.btn_home_speaker_sect.sizePolicy().hasHeightForWidth())
        self.btn_home_speaker_sect.setSizePolicy(sizePolicy7)
        self.btn_home_speaker_sect.setFont(font3)
        self.btn_home_speaker_sect.setStyleSheet(u"QPushButton:disabled{\n"
"  background-color: rgb(121, 121, 121);\n"
"}")
        ...
        self.btn_home_annotformat_sect.setObjectName(u"btn_home_annotformat_sect")
        sizePolicy7.setHeightForWidth(self.btn_home_annotformat_sect.sizePolicy().hasHeightForWidth())
        self.btn_home_annotformat_sect.setSizePolicy(sizePolicy7)
        self.btn_home_annotformat_sect.setFont(font3)
        self.btn_home_annotformat_sect.setStyleSheet(u"QPushButton:disabled{\n"
"  background-color: rgb(121, 121, 121);\n"
"}")
        ...
        self.btn_home_varmanag_sect.setObjectName(u"btn_home_varmanag_sect")
        sizePolicy7.setHeightForWidth(self.btn_home_varmanag_sect.sizePolicy().hasHeightForWidth())
        self.btn_home_varmanag_sect.setSizePolicy(sizePolicy7)
        self.btn_home_varmanag_sect.setFont(font3)
        self.btn_home_varmanag_sect.setStyleSheet(u"QPushButton:disabled{\n"
"  background-color: rgb(121, 121, 121);\n"
"}")

        self.verticalLayout_5.addWidget(self.btn_home_varmanag_sect, 0, Qt.AlignTop)

        self.btn_home_analysissettings_sect = QPushButton(self.scrollAreaWidgetContents_3)
        self.btn_home_analysissettings_sect.setObjectName(u"btn_home_analysissettings_sect")
        sizePolicy7.setHeightForWidth(self.btn_home_analysissettings_sect.sizePolicy().hasHeightForWidth())
        self.btn_home_analysissettings_sect.setSizePolicy(sizePolicy7)
        self.btn_home_analysissettings_sect.setFont(font3)
        self.btn_home_analysissettings_sect.setStyleSheet(u"QPushButton:disabled{\n"
"  background-color: rgb(121, 121, 121);\n"
"}")

        self.verticalLayout_5.addWidget(self.btn_home_analysissettings_sect, 0, Qt.AlignTop)

        self.btn_home_annotation_sect = QPushButton(self.scrollAreaWidgetContents_3)
        self.btn_home_annotation_sect.setObjectName(u"btn_home_annotation_sect")
        self.btn_home_annotation_sect.setEnabled(False)
        sizePolicy7.setHeightForWidth(self.btn_home_annotation_sect.sizePolicy().hasHeightForWidth())
        self.btn_home_annotation_sect.setSizePolicy(sizePolicy7)
        self.btn_home_annotation_sect.setFont(font3)
        self.btn_home_annotation_sect.setStyleSheet(u"QPushButton {\n"
...
"}")
        ...
        self.label_warning_loaded_files.setObjectName(u"label_warning_loaded_files")
        self.label_warning_loaded_files.setMaximumSize(QSize(24, 24))
        self.label_warning_loaded_files.setPixmap(QPixmap(u":/images/images/warning_symbol.png"))
        ...
        self.label_loadedfiles.setObjectName(u"label_loadedfiles")
        font4 = QFont()
        ...
        self.label_loadedfiles_content.setObjectName(u"label_loadedfiles_content")
        self.label_loadedfiles_content.setFont(font4)

        self.gridLayout.addWidget(self.label_loadedfiles_content, 0, 2, 1, 1, Qt.AlignRight)

        self.label_warning_speakers = QLabel(self.gridWidget)
        self.label_warning_speakers.setObjectName(u"label_warning_speakers")
        self.label_warning_speakers.setMaximumSize(QSize(24, 24))
        self.label_warning_speakers.setPixmap(QPixmap(u":/images/images/warning_symbol.png"))
        ...
        self.label_uniquespeakers.setObjectName(u"label_uniquespeakers")
        ...
        self.label_uniquespeakers_content.setObjectName(u"label_uniquespeakers_content")
        self.label_uniquespeakers_content.setFont(font4)

        self.gridLayout.addWidget(self.label_uniquespeakers_content, 1, 2, 1, 1, Qt.AlignRight)

        self.label_warning_dvs = QLabel(self.gridWidget)
        self.label_warning_dvs.setObjectName(u"label_warning_dvs")
        self.label_warning_dvs.setMaximumSize(QSize(24, 24))
        self.label_warning_dvs.setPixmap(QPixmap(u":/images/images/warning_symbol.png"))
        ...
        self.label_dvs_content.setObjectName(u"label_dvs_content")
        ...
        self.label_warning_dv_variants.setObjectName(u"label_warning_dv_variants")
        self.label_warning_dv_variants.setMaximumSize(QSize(24, 24))
        self.label_warning_dv_variants.setPixmap(QPixmap(u":/images/images/warning_symbol.png"))
        ...
        self.label_dv_variants.setObjectName(u"label_dv_variants")
        ...
        self.label_dv_variants_content.setObjectName(u"label_dv_variants_content")
        self.label_dv_variants_content.setFont(font4)

        self.gridLayout.addWidget(self.label_dv_variants_content, 3, 2, 1, 1, Qt.AlignRight)

        self.label_warning_ivs = QLabel(self.gridWidget)
        self.label_warning_ivs.setObjectName(u"label_warning_ivs")
        self.label_warning_ivs.setMaximumSize(QSize(24, 24))
        self.label_warning_ivs.setPixmap(QPixmap(u":/images/images/warning_symbol.png"))
        ...
        self.label_ivs_contents.setObjectName(u"label_ivs_contents")
        ...
        self.label_warning_iv_values.setObjectName(u"label_warning_iv_values")
        self.label_warning_iv_values.setMaximumSize(QSize(24, 24))
        self.label_warning_iv_values.setPixmap(QPixmap(u":/images/images/warning_symbol.png"))
        ...
        self.label_iv_values.setObjectName(u"label_iv_values")
        ...
        self.label_iv_values_content.setObjectName(u"label_iv_values_content")
        self.label_iv_values_content.setFont(font4)

        self.gridLayout.addWidget(self.label_iv_values_content, 5, 2, 1, 1, Qt.AlignRight)

        self.label_warning_annotations = QLabel(self.gridWidget)
        self.label_warning_annotations.setObjectName(u"label_warning_annotations")
        self.label_warning_annotations.setMaximumSize(QSize(24, 24))
        self.label_warning_annotations.setPixmap(QPixmap(u":/images/images/warning_symbol.png"))
        ...
        self.label_annotations.setObjectName(u"label_annotations")
        ...
        self.label_annotations_content.setObjectName(u"label_annotations_content")
        self.label_annotations_content.setFont(font4)

        self.gridLayout.addWidget(self.label_annotations_content, 6, 2, 1, 1, Qt.AlignRight)

        self.label_warning_annotationformats = QLabel(self.gridWidget)
        self.label_warning_annotationformats.setObjectName(u"label_warning_annotationformats")
        self.label_warning_annotationformats.setMaximumSize(QSize(24, 24))
        self.label_warning_annotationformats.setPixmap(QPixmap(u":/images/images/warning_symbol.png"))
        ...
        self.label_annotationformat.setObjectName(u"label_annotationformat")
        ...
        self.label_annotationformat_contents.setObjectName(u"label_annotationformat_contents")
        self.label_annotationformat_contents.setFont(font4)

        self.gridLayout.addWidget(self.label_annotationformat_contents, 7, 2, 1, 1, Qt.AlignRight)
    ...
    def retranslateUi(self, HomeMenuTab):
        ...
        self.btn_home_analysecorpus.setText(QCoreApplication.translate("HomeMenuTab", u"Analyse Corpus", None))
        self.proj_name_label.setText(QCoreApplication.translate("HomeMenuTab", u"Current Project: <Project Name>", None))
        self.btn_projectinformation.setText(QCoreApplication.translate("HomeMenuTab", u"Project Information", None))
        self.label_home_maintitle.setText(QCoreApplication.translate("HomeMenuTab", u"Menu Selection", None))
        self.btn_closeproject.setText(QCoreApplication.translate("HomeMenuTab", u"Close Project", None))
        self.btn_settings.setText(QCoreApplication.translate("HomeMenuTab", u"Settings", None))
        self.btn_home_managecorpus_sect.setText(QCoreApplication.translate("HomeMenuTab", u"Corpus-File-Management", None))
        self.btn_home_speaker_sect.setText(QCoreApplication.translate("HomeMenuTab", u"Speaker-Identification", None))
        self.btn_home_annotformat_sect.setText(QCoreApplication.translate("HomeMenuTab", u"Annotation-Specification", None))
        self.btn_home_varmanag_sect.setText(QCoreApplication.translate("HomeMenuTab", u"Metadata-Management", None))
        self.btn_home_analysissettings_sect.setText(QCoreApplication.translate("HomeMenuTab", u"Analysis-Settings", None))
        self.btn_home_annotation_sect.setText(QCoreApplication.translate("HomeMenuTab", u"Annotate Corpus", None))
        self.label_warning_loaded_files.setText("")
        self.label_loadedfiles.setText(QCoreApplication.translate("HomeMenuTab", u"Loaded files in corpus:", None))
        self.label_loadedfiles_content.setText(QCoreApplication.translate("HomeMenuTab", u"0", None))
        self.label_warning_speakers.setText("")
        self.label_uniquespeakers.setText(QCoreApplication.translate("HomeMenuTab", u"Unique speakers:", None))
        self.label_uniquespeakers_content.setText(QCoreApplication.translate("HomeMenuTab", u"0", None))
        self.label_warning_dvs.setText("")
        self.label_dvs.setText(QCoreApplication.translate("HomeMenuTab", u"Dependent Variables:", None))
        self.label_dvs_content.setText(QCoreApplication.translate("HomeMenuTab", u"0", None))
        self.label_warning_dv_variants.setText("")
        self.label_dv_variants.setText(QCoreApplication.translate("HomeMenuTab", u"Unique DV-Variants:", None))
        self.label_dv_variants_content.setText(QCoreApplication.translate("HomeMenuTab", u"0", None))
        self.label_warning_ivs.setText("")
        self.label_ivs.setText(QCoreApplication.translate("HomeMenuTab", u"Independent Variables:", None))
        self.label_ivs_contents.setText(QCoreApplication.translate("HomeMenuTab", u"0", None))
        self.label_warning_iv_values.setText("")
        self.label_iv_values.setText(QCoreApplication.translate("HomeMenuTab", u"Unique IV-Variants:", None))
        self.label_iv_values_content.setText(QCoreApplication.translate("HomeMenuTab", u"0", None))
        self.label_warning_annotations.setText("")
        self.label_annotations.setText(QCoreApplication.translate("HomeMenuTab", u"Annotations:", None))
        self.label_annotations_content.setText(QCoreApplication.translate("HomeMenuTab", u"0", None))
        self.label_warning_annotationformats.setText("")
        self.label_annotationformat.setText(QCoreApplication.translate("HomeMenuTab", u"Current Annotation Formats:", None))
        self.label_annotationformat_contents.setText(QCoreApplication.translate("HomeMenuTab", u"0", None))
        pass
    # retranslateUi
