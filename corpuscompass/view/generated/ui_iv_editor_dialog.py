...
################################################################################
## Form generated from reading UI file 'iv_editor_dialog.ui'
##
...
"}")
        icon = QIcon()
        icon.addFile(u":/images/images/checked_icon.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"}")
        icon2 = QIcon()
        icon2.addFile(u":/images/images/Plus_Icon.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
