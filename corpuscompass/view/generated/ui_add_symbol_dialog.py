...
################################################################################
## Form generated from reading UI file 'add_symbol_dialog.ui'
##
...
class Ui_AddSymbolsDialog(object):
    def setupUi(self, AddSymbolsDialog):
        if not AddSymbolsDialog.objectName():
            AddSymbolsDialog.setObjectName(u"AddSymbolsDialog")
        ...
        self.label_symbolalreadyadded.setObjectName(u"label_symbolalreadyadded")
        self.label_symbolalreadyadded.setStyleSheet(u"QLabel{color: red}")
        ...
        self.listwidget_annotformat_oldsymbols.setObjectName(u"listwidget_annotformat_oldsymbols")
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.listwidget_annotformat_oldsymbols.sizePolicy().hasHeightForWidth())
        ...
        self.listwidget_annotformat_oldsymbols.setStyleSheet(u"")
        self.listwidget_annotformat_oldsymbols.setDragEnabled(True)
        self.listwidget_annotformat_oldsymbols.setDragDropMode(QAbstractItemView.DragOnly)
        ...
        self.listwidget_annotformat_oldsymbols.setProperty(u"isWrapping", True)
        ...
        self.lineEdit_newsymbol.setObjectName(u"lineEdit_newsymbol")
        ...
        self.listwidget_annotformat_symbolcontainer.setHorizontalScrollBarPolicy(Qt.ScrollBarAlwaysOff)
        ...
        self.gridLayout.addWidget(self.listwidget_annotformat_symbolcontainer, 3, 1, 1, 1)

        self.label_addsymbol = QLabel(self.widget)
        self.label_addsymbol.setObjectName(u"label_addsymbol")
        font1 = QFont()
        ...
        self.btn_addsymbol.setObjectName(u"btn_addsymbol")

        self.gridLayout.addWidget(self.btn_addsymbol, 7, 1, 1, 1)

        self.label_currentsymbols = QLabel(self.widget)
        self.label_currentsymbols.setObjectName(u"label_currentsymbols")
    ...
    def retranslateUi(self, AddSymbolsDialog):
        AddSymbolsDialog.setWindowTitle(QCoreApplication.translate("AddSymbolsDialog", u"Dialog", None))
        self.label_symbolalreadyadded.setText(QCoreApplication.translate("AddSymbolsDialog", u"Symbol already added!", None))
        self.lineEdit_newsymbol.setText("")
        self.lineEdit_newsymbol.setPlaceholderText(QCoreApplication.translate("AddSymbolsDialog", u"Type in symbol to add...", None))
        self.label_addsymbol.setText(QCoreApplication.translate("AddSymbolsDialog", u"Add Symbol:", None))
        self.btn_addsymbol.setText(QCoreApplication.translate("AddSymbolsDialog", u"+", None))
        self.label_currentsymbols.setText(QCoreApplication.translate("AddSymbolsDialog", u"Current Symbols:", None))
        self.label.setText(QCoreApplication.translate("AddSymbolsDialog", u"Newly added symbols:", None))
    # retranslateUi
