...
################################################################################
## Form generated from reading UI file 'load_files_tab.ui'
##
...
class Ui_LoadFilesTab(object):
    def setupUi(self, LoadFilesTab):
        if not LoadFilesTab.objectName():
            LoadFilesTab.setObjectName(u"LoadFilesTab")
        LoadFilesTab.resize(1280, 720)
        LoadFilesTab.setStyleSheet(u"QWidget{\n"
...
"}")
        ...
        self.list_loaded_filenames.setObjectName(u"list_loaded_filenames")
        self.list_loaded_filenames.setStyleSheet(u"QAbstractItemView::indicator{\n"
"	width: 20px;\n"
"	height: 20px;\n"
"}\n"
"\n"
...
"    background-color: rgba(50, 50, 225, 0.1); \n"
"	color:black;\n"
"}\n"
"\n"
...
"    background-color: li"
                        "ghtgray; /* Example: change background color when hovering */\n"
"}\n"
"\n"
"QAbstractItemView::indicator:checked:hover {\n"
"    /* Adjust the appearance of the checked checkbox when hovering */\n"
"    background-color: rgb(155, 154, 154); /* Example: change background color of checked checkbox when hovering */\n"
"\n"
"}\n"
"\n"
"\n"
...
"")
        ...
        self.tab_file_preview.setObjectName(u"tab_file_preview")
        ...
        self.btn_finished.setObjectName(u"btn_finished")
        sizePolicy2 = QSizePolicy(QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.btn_finished.sizePolicy().hasHeightForWidth())
        self.btn_finished.setSizePolicy(sizePolicy2)
        self.btn_finished.setMinimumSize(QSize(84, 44))
        self.btn_finished.setFont(font)
        self.btn_finished.setStyleSheet(u"QPushButton {\n"
"	color: white;\n"
...
"")
    ...
    def retranslateUi(self, LoadFilesTab):
        self.label.setText(QCoreApplication.translate("LoadFilesTab", u"Loaded Files", None))
        ___qtablewidgetitem = self.list_loaded_filenames.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("LoadFilesTab", u"Neue Spalte", None));
        ___qtablewidgetitem1 = self.list_loaded_filenames.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("LoadFilesTab", u"File-Name", None));
        self.btn_add_file.setText(QCoreApplication.translate("LoadFilesTab", u"Add File", None))
        self.btn_remove_file.setText(QCoreApplication.translate("LoadFilesTab", u"Remove selected\n"
"Files", None))
        self.btn_finished.setText(QCoreApplication.translate("LoadFilesTab", u"Save", None))
        pass
    # retranslateUi
