...
class Ui_SpeakerEditorDialog(object):
    def setupUi(self, SpeakerEditorDialog):
        if not SpeakerEditorDialog.objectName():
            SpeakerEditorDialog.setObjectName("SpeakerEditorDialog")
        ...
        self.widget_colorcontents.setObjectName("widget_colorcontents")
        ...
        self.label_currentcolor.setObjectName("label_currentcolor")
        ...
        sizePolicy.setHeightForWidth(
            self.label_currentcolor.sizePolicy().hasHeightForWidth()
        )
        ...
        self.horizontalSpacer_2 = QSpacerItem(
            15, 20, QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Minimum
        )

        self.horizontalLayout.addItem(self.horizontalSpacer_2)

        self.label_colorsquare = QLabel(self.widget_colorcontents)
        self.label_colorsquare.setObjectName("label_colorsquare")
        ...
        sizePolicy1.setHeightForWidth(
            self.btn_changecolor.sizePolicy().hasHeightForWidth()
        )
        ...
        self.label_speakername.setObjectName("label_speakername")
        ...
        sizePolicy2.setHeightForWidth(
            self.label_speakername.sizePolicy().hasHeightForWidth()
        )
        ...
        self.comboBox_selectspeaker.setObjectName("comboBox_selectspeaker")
        self.comboBox_selectspeaker.setMinimumSize(QSize(119, 25))
        self.comboBox_selectspeaker.setStyleSheet(
            "QComboBox {\n"
        ...
        self.btn_delete_speaker.setObjectName("btn_delete_speaker")
        self.btn_delete_speaker.setEnabled(False)
        self.btn_delete_speaker.setMinimumSize(QSize(25, 25))
        self.btn_delete_speaker.setStyleSheet(
            "QPushButton {\n"
        ...
        self.label_speakerselect.setObjectName("label_speakerselect")
        ...
        self.label_duplicate_color.setObjectName("label_duplicate_color")
        self.label_duplicate_color.setFont(font1)
        self.label_duplicate_color.setStyleSheet("QLabel{color: red;}")
    ...
    def retranslateUi(self, SpeakerEditorDialog):
        SpeakerEditorDialog.setWindowTitle(
            QCoreApplication.translate("SpeakerEditorDialog", "Dialog", None)
        )
        self.label_currentcolor.setText(
            QCoreApplication.translate("SpeakerEditorDialog", "Color:", None)
        )
        self.btn_changecolor.setText(
            QCoreApplication.translate("SpeakerEditorDialog", "Change Color", None)
        )
        self.groupBox_ivs.setTitle(
            QCoreApplication.translate(
                "SpeakerEditorDialog", "Set Speaker-Attributes (based on IVs)", None
            )
        )
        self.label_speakername.setText(
            QCoreApplication.translate(
                "SpeakerEditorDialog", "Speaker-Names cannot be changed:", None
            )
        )
        self.label_variableinputwarning.setText("")
        self.comboBox_selectspeaker.setCurrentText("")
        self.comboBox_selectspeaker.setPlaceholderText(
            QCoreApplication.translate("SpeakerEditorDialog", "Select Speaker...", None)
        )
        self.btn_delete_speaker.setText("")
        self.label_speakerselect.setText(
            QCoreApplication.translate(
                "SpeakerEditorDialog", "Select Speaker to edit:", None
            )
        )
        self.lineEdit_nameinput.setPlaceholderText(
            QCoreApplication.translate(
                "SpeakerEditorDialog", "Input Speaker-Name", None
            )
        )
        self.label_header.setText(
            QCoreApplication.translate("SpeakerEditorDialog", "Speaker - Edit", None)
        )
        self.label_duplicate_color.setText(
            QCoreApplication.translate(
                "SpeakerEditorDialog",
                "The selected color is a duplicate! Please select a different color!",
                None,
            )
        )
