...
class Ui_GenericWarningDialog(object):
    def setupUi(self, GenericWarningDialog):
        if not GenericWarningDialog.objectName():
            GenericWarningDialog.setObjectName("GenericWarningDialog")
    ...
    def retranslateUi(self, GenericWarningDialog):
        GenericWarningDialog.setWindowTitle(
            QCoreApplication.translate("GenericWarningDialog", "Dialog", None)
        )
        self.label_header.setText(
            QCoreApplication.translate("GenericWarningDialog", "Warning!", None)
        )
        self.label_2.setText(
            QCoreApplication.translate(
                "GenericWarningDialog",
                "If you do not wish to save your changes, all progress since the last save will be lost! Proceed?",
                None,
            )
        )
