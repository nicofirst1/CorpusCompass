...
class Ui_EditorAnnotationformatDialog(object):
    def setupUi(self, EditorAnnotationformatDialog):
        if not EditorAnnotationformatDialog.objectName():
            EditorAnnotationformatDialog.setObjectName(u"EditorAnnotationformatDialog")
        ...
        self.widget_annotdial_overall.setObjectName(u"widget_annotdial_overall")
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.widget_annotdial_overall.sizePolicy().hasHeightForWidth())
        ...
        self.widget_specificationcontents.setObjectName(u"widget_specificationcontents")
        self.widget_specificationcontents.setEnabled(False)
        sizePolicy.setHeightForWidth(self.widget_specificationcontents.sizePolicy().hasHeightForWidth())
        ...
        self.btn_resetseparator.setObjectName(u"btn_resetseparator")
        self.btn_resetseparator.setStyleSheet(u"QPushButton {\n"
...
"")
        icon = QIcon()
        icon.addFile(u":/images/images/refresh_icon.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.label_3.setPixmap(QPixmap(u":/images/images/trash_icon_fat.png"))
        ...
        self.btn_annotdial_resetformat.setObjectName(u"btn_annotdial_resetformat")
        self.btn_annotdial_resetformat.setStyleSheet(u"QPushButton {\n"
"    background-color: white;\n"
"    border: 1px solid white;\n"
"	color: white;\n"
" 	height: 30px;\n"
...
"")
        ...
        self.listwidget_annotformat_tokenidentcontainer = QListWidget(self.widget_specificationcontents)
        self.listwidget_annotformat_tokenidentcontainer.setObjectName(u"listwidget_annotformat_tokenidentcontainer")
        sizePolicy1 = QSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.listwidget_annotformat_tokenidentcontainer.sizePolicy().hasHeightForWidth())
        ...
        self.listwidget_annotformat_tokenidentcontainer.setMaximumSize(QSize(16777215, 100))
        self.listwidget_annotformat_tokenidentcontainer.setDragEnabled(True)
        self.listwidget_annotformat_tokenidentcontainer.setDragDropMode(QAbstractItemView.DragOnly)
        self.listwidget_annotformat_tokenidentcontainer.setDefaultDropAction(Qt.MoveAction)
        self.listwidget_annotformat_tokenidentcontainer.setFlow(QListView.TopToBottom)

        self.gridLayout_2.addWidget(self.listwidget_annotformat_tokenidentcontainer, 8, 0, 1, 1)

        self.label_annotdial_helpinput = QLabel(self.widget_specificationcontents)
        self.label_annotdial_helpinput.setObjectName(u"label_annotdial_helpinput")
        self.label_annotdial_helpinput.setToolTipDuration(-1)
        self.label_annotdial_helpinput.setPixmap(QPixmap(u":/images/images/Help_Icon.svg"))

        self.gridLayout_2.addWidget(self.label_annotdial_helpinput, 3, 3, 1, 1, Qt.AlignRight)

        self.vwidget_corpuspreview = QWidget(self.widget_specificationcontents)
        self.vwidget_corpuspreview.setObjectName(u"vwidget_corpuspreview")
        ...
        self.label_corpuspreview.setObjectName(u"label_corpuspreview")
        sizePolicy2 = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Maximum)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.label_corpuspreview.sizePolicy().hasHeightForWidth())
        ...
        self.tablewidget_annotdial_corpuspreview = QTableWidget(self.vwidget_corpuspreview)
        ...
        self.tablewidget_annotdial_corpuspreview.setHorizontalHeaderItem(0, __qtablewidgetitem)
        __qtablewidgetitem1 = QTableWidgetItem()
        __qtablewidgetitem1.setFont(font2);
        self.tablewidget_annotdial_corpuspreview.setHorizontalHeaderItem(1, __qtablewidgetitem1)
        __qtablewidgetitem2 = QTableWidgetItem()
        __qtablewidgetitem2.setFont(font2);
        self.tablewidget_annotdial_corpuspreview.setHorizontalHeaderItem(2, __qtablewidgetitem2)
        self.tablewidget_annotdial_corpuspreview.setObjectName(u"tablewidget_annotdial_corpuspreview")
        self.tablewidget_annotdial_corpuspreview.setStyleSheet(u"QTableWidget {\n"
...
"\n"
"}")
        self.tablewidget_annotdial_corpuspreview.setEditTriggers(QAbstractItemView.NoEditTriggers)
        self.tablewidget_annotdial_corpuspreview.setRowCount(0)
        self.tablewidget_annotdial_corpuspreview.horizontalHeader().setDefaultSectionSize(125)
        self.tablewidget_annotdial_corpuspreview.horizontalHeader().setStretchLastSection(True)
        ...
        self.label_inputwarningmessage.setObjectName(u"label_inputwarningmessage")
        font4 = QFont()
        font4.setPointSize(10)
        font4.setBold(True)
        self.label_inputwarningmessage.setFont(font4)
        self.label_inputwarningmessage.setStyleSheet(u"QLabel{color:red;}")

        self.gridLayout_2.addWidget(self.label_inputwarningmessage, 3, 1, 1, 1)

        self.listwidget_annotdial_inputformat = QListWidget(self.widget_specificationcontents)
        self.listwidget_annotdial_inputformat.setObjectName(u"listwidget_annotdial_inputformat")
        sizePolicy1.setHeightForWidth(self.listwidget_annotdial_inputformat.sizePolicy().hasHeightForWidth())
        ...
        self.listwidget_annotdial_inputformat.setStyleSheet(u"")
        ...
        self.listwidget_annotdial_inputformat.setDragDropMode(QAbstractItemView.DragDrop)
        ...
        self.label_inputformat.setObjectName(u"label_inputformat")
        sizePolicy3 = QSizePolicy(QSizePolicy.Policy.Maximum, QSizePolicy.Policy.Preferred)
        sizePolicy3.setHorizontalStretch(0)
        sizePolicy3.setVerticalStretch(0)
        sizePolicy3.setHeightForWidth(self.label_inputformat.sizePolicy().hasHeightForWidth())
        ...
        self.verticalSpacer_2 = QSpacerItem(20, 55, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.gridLayout_2.addItem(self.verticalSpacer_2, 2, 0, 1, 1)

        self.widget_multipleall = QWidget(self.widget_specificationcontents)
        self.widget_multipleall.setObjectName(u"widget_multipleall")
        ...
        self.checkbox_annotdial_multipleannot.setObjectName(u"checkbox_annotdial_multipleannot")
        font7 = QFont()
        ...
        self.listwidget_annotdial_separatorsymbols = QListWidget(self.widget_multipleall)
        self.listwidget_annotdial_separatorsymbols.setObjectName(u"listwidget_annotdial_separatorsymbols")
        ...
        self.listwidget_annotdial_separatorsymbols.setDragDropMode(QAbstractItemView.DragDrop)
        ...
        self.listwidget_annotformat_removeelems = QListWidget(self.widget_specificationcontents)
        self.listwidget_annotformat_removeelems.setObjectName(u"listwidget_annotformat_removeelems")
        sizePolicy1.setHeightForWidth(self.listwidget_annotformat_removeelems.sizePolicy().hasHeightForWidth())
        ...
        self.listwidget_annotformat_removeelems.setStyleSheet(u"QListWidget { background-color: rgb(255, 176, 177); }")
        self.listwidget_annotformat_removeelems.setDragEnabled(True)
        self.listwidget_annotformat_removeelems.setDragDropMode(QAbstractItemView.DropOnly)
        ...
        self.btn_annotdial_addsymbols.setObjectName(u"btn_annotdial_addsymbols")

        self.gridLayout_2.addWidget(self.btn_annotdial_addsymbols, 9, 1, 1, 1)

        self.label_annotdial_customdescription = QLabel(self.widget_specificationcontents)
        self.label_annotdial_customdescription.setObjectName(u"label_annotdial_customdescription")
        font10 = QFont()
        ...
        self.listwidget_annotformat_symbolcontainer = QListWidget(self.widget_specificationcontents)
        self.listwidget_annotformat_symbolcontainer.setObjectName(u"listwidget_annotformat_symbolcontainer")
        sizePolicy1.setHeightForWidth(self.listwidget_annotformat_symbolcontainer.sizePolicy().hasHeightForWidth())
        ...
        self.groupBox_softwarebtns.setObjectName(u"groupBox_softwarebtns")
        ...
        self.radbtn_annotdial_elanformat.setObjectName(u"radbtn_annotdial_elanformat")
        ...
        sizePolicy4.setHeightForWidth(self.radbtn_annotdial_elanformat.sizePolicy().hasHeightForWidth())
        ...
        self.radbtn_annotdial_praatformat.setObjectName(u"radbtn_annotdial_praatformat")
        self.radbtn_annotdial_praatformat.setEnabled(False)
        sizePolicy4.setHeightForWidth(self.radbtn_annotdial_praatformat.sizePolicy().hasHeightForWidth())
        ...
        self.radbtn_annotdial_flexformat.setObjectName(u"radbtn_annotdial_flexformat")
        self.radbtn_annotdial_flexformat.setEnabled(False)
        sizePolicy4.setHeightForWidth(self.radbtn_annotdial_flexformat.sizePolicy().hasHeightForWidth())
        ...
        self.label_annotdial_help_praat.setObjectName(u"label_annotdial_help_praat")
        sizePolicy5 = QSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Fixed)
        sizePolicy5.setHorizontalStretch(0)
        sizePolicy5.setVerticalStretch(0)
        sizePolicy5.setHeightForWidth(self.label_annotdial_help_praat.sizePolicy().hasHeightForWidth())
        self.label_annotdial_help_praat.setSizePolicy(sizePolicy5)
        self.label_annotdial_help_praat.setPixmap(QPixmap(u":/images/images/Help_Icon.svg"))
        ...
        self.label_annotdial_help_elan.setObjectName(u"label_annotdial_help_elan")
        sizePolicy5.setHeightForWidth(self.label_annotdial_help_elan.sizePolicy().hasHeightForWidth())
        self.label_annotdial_help_elan.setSizePolicy(sizePolicy5)
        self.label_annotdial_help_elan.setPixmap(QPixmap(u":/images/images/Help_Icon.svg"))
        ...
        self.label_annotdial_help_flex.setObjectName(u"label_annotdial_help_flex")
        sizePolicy5.setHeightForWidth(self.label_annotdial_help_flex.sizePolicy().hasHeightForWidth())
        self.label_annotdial_help_flex.setSizePolicy(sizePolicy5)
        self.label_annotdial_help_flex.setPixmap(QPixmap(u":/images/images/Help_Icon.svg"))

        self.gridLayout_4.addWidget(self.label_annotdial_help_flex, 3, 1, 1, 1)


        self.gridLayout_3.addWidget(self.groupBox_softwarebtns, 6, 0, 1, 1, Qt.AlignLeft)

        self.radbtn_annotdial_customstyle = QRadioButton(self.widget_annotdial_overall)
        self.radbtn_annotdial_customstyle.setObjectName(u"radbtn_annotdial_customstyle")
        self.radbtn_annotdial_customstyle.setFont(font5)
        self.radbtn_annotdial_customstyle.setChecked(True)

        self.gridLayout_3.addWidget(self.radbtn_annotdial_customstyle, 2, 0, 1, 1, Qt.AlignTop)

        self.radbtn_annotdial_colorbased = QRadioButton(self.widget_annotdial_overall)
        self.radbtn_annotdial_colorbased.setObjectName(u"radbtn_annotdial_colorbased")
        self.radbtn_annotdial_colorbased.setEnabled(False)
        self.radbtn_annotdial_colorbased.setFont(font5)

        self.gridLayout_3.addWidget(self.radbtn_annotdial_colorbased, 7, 0, 1, 2, Qt.AlignTop)

        self.radbtn_annotdial_othersoft = QRadioButton(self.widget_annotdial_overall)
        self.radbtn_annotdial_othersoft.setObjectName(u"radbtn_annotdial_othersoft")
...
"")
        ...
        self.btn_delete_annotformat.setObjectName(u"btn_delete_annotformat")
        self.btn_delete_annotformat.setEnabled(False)
        sizePolicy4.setHeightForWidth(self.btn_delete_annotformat.sizePolicy().hasHeightForWidth())
        self.btn_delete_annotformat.setSizePolicy(sizePolicy4)
        self.btn_delete_annotformat.setMinimumSize(QSize(35, 35))
        self.btn_delete_annotformat.setStyleSheet(u"QPushButton {\n"
"    background-color: lightgrey;\n"
"    border: 1px solid white;\n"
"	color: white;\n"
"}\n"
...
"}")
        icon1 = QIcon()
        icon1.addFile(u":/images/images/trash_icon.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
    ...
    def retranslateUi(self, EditorAnnotationformatDialog):
        EditorAnnotationformatDialog.setWindowTitle(QCoreApplication.translate("EditorAnnotationformatDialog", u"Dialog", None))
#if QT_CONFIG(tooltip)
        self.btn_resetseparator.setToolTip(QCoreApplication.translate("EditorAnnotationformatDialog", u"<html><head/><body><p><span style=\" font-weight:700;\">Reset separator</span></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.btn_resetseparator.setText("")
        self.label_3.setText("")
#if QT_CONFIG(tooltip)
        self.btn_annotdial_resetformat.setToolTip(QCoreApplication.translate("EditorAnnotationformatDialog", u"<html><head/><body><p><span style=\" font-weight:700;\">Reset input</span></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.btn_annotdial_resetformat.setText("")
#if QT_CONFIG(tooltip)
        self.label_annotdial_helpinput.setToolTip(QCoreApplication.translate("EditorAnnotationformatDialog", u"<html><head/><body><p><span style=\" font-size:12pt; font-weight:700; text-decoration: underline;\">How to specify the annotation format:</span></p><p><span style=\" font-size:10pt;\">The format can be built by dragging and dropping the corresponding elements in the &quot;input&quot; field at the top and (optionally) the &quot;separator&quot; field below. </span></p><p><span style=\" font-size:10pt;\">1. Each annotation-format needs to contain the &quot;token&quot; and &quot;identifier&quot;, which indicate where the original word (&quot;token&quot;), and where the added DV-Variant (&quot;identifier&quot;) is located in the annotation.</span></p><p><span style=\" font-size:10pt;\">2. To complete the annotation format, the symbols that were used to mark the annotations in the original corpus need to be placed and the correct position that matches the pattern of the original annotations.</span></p><p><span style=\" font-size:10pt;\">3. If the original corpus contains annotations with multiple DV-Variants in just"
                        " one annotation, the user may input the symbols that were used to separate these variants by checking the checkbox and dragging the symbols in the &quot;separator&quot;-field.</span></p><p><span style=\" font-size:10pt; font-style:italic;\">For more detailled information, click the &quot;Help-Button&quot; in the previous window that contains the table with all annotation formats.</span></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.label_annotdial_helpinput.setText("")
        self.label_corpuspreview.setText(QCoreApplication.translate("EditorAnnotationformatDialog", u"Preview", None))
        ___qtablewidgetitem = self.tablewidget_annotdial_corpuspreview.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("EditorAnnotationformatDialog", u"Token", None));
        ___qtablewidgetitem1 = self.tablewidget_annotdial_corpuspreview.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("EditorAnnotationformatDialog", u"#Annotations", None));
        ___qtablewidgetitem2 = self.tablewidget_annotdial_corpuspreview.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("EditorAnnotationformatDialog", u"Identifiers", None));
        self.label_total_detected_annotations.setText(QCoreApplication.translate("EditorAnnotationformatDialog", u"Total detected annotations: X", None))
        self.btn_testcurrentformat.setText(QCoreApplication.translate("EditorAnnotationformatDialog", u"Test current input", None))
        self.btn_loadmore.setText(QCoreApplication.translate("EditorAnnotationformatDialog", u"Load more...", None))
        self.label_4.setText(QCoreApplication.translate("EditorAnnotationformatDialog", u"Could not identify any more annotations!", None))
        self.label_inputwarningmessage.setText("")
        self.label_inputformat.setText(QCoreApplication.translate("EditorAnnotationformatDialog", u"Input your Annotation-Format:", None))
#if QT_CONFIG(tooltip)
        self.checkbox_annotdial_multipleannot.setToolTip(QCoreApplication.translate("EditorAnnotationformatDialog", u"<html><head/><body><p>Check the box and add the separator symbol(s) (by dragging them in from above), if your corpus includes words that have more than one annotation.</p><p><span style=\" font-weight:700; font-style:italic;\">Multiple Identifiers </span><span style=\" font-style:italic;\">refer to tokens (&quot;words&quot;) in the corpus, that are annotated more than once. For each annotation, the corresponding identifer of the Dependent Variable Variant should be included in the annotation. The separator indicates the symbol that was used to separate the identifiers in the annotations.</span></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.checkbox_annotdial_multipleannot.setText(QCoreApplication.translate("EditorAnnotationformatDialog", u"Multiple identifiers per token possible?", None))
        self.label_separator.setText(QCoreApplication.translate("EditorAnnotationformatDialog", u"Separator: ", None))
        self.label.setText(QCoreApplication.translate("EditorAnnotationformatDialog", u"Token & Identifier", None))
        self.btn_annotdial_addsymbols.setText(QCoreApplication.translate("EditorAnnotationformatDialog", u"Add more symbols...", None))
        self.label_annotdial_customdescription.setText(QCoreApplication.translate("EditorAnnotationformatDialog", u"Define the style/format you used for annotations in your already annotated corpus by dragging the elements in their corresponding position", None))
        self.label_2.setText(QCoreApplication.translate("EditorAnnotationformatDialog", u"Available Symbols", None))
        self.groupBox_softwarebtns.setTitle("")
        self.radbtn_annotdial_elanformat.setText(QCoreApplication.translate("EditorAnnotationformatDialog", u"ELAN", None))
        self.radbtn_annotdial_praatformat.setText(QCoreApplication.translate("EditorAnnotationformatDialog", u"Praat", None))
        self.radbtn_annotdial_flexformat.setText(QCoreApplication.translate("EditorAnnotationformatDialog", u"Flex", None))
        self.label_annotdial_help_praat.setText("")
        self.label_annotdial_help_elan.setText("")
        self.label_annotdial_help_flex.setText("")
        self.radbtn_annotdial_customstyle.setText(QCoreApplication.translate("EditorAnnotationformatDialog", u"Specify custom annotation format", None))
