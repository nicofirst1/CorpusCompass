...
################################################################################
## Form generated from reading UI file 'start_screen_tab.ui'
##
...
class Ui_StartScreenTab(object):
    def setupUi(self, StartScreenTab):
        if not StartScreenTab.objectName():
            StartScreenTab.setObjectName(u"StartScreenTab")
        StartScreenTab.resize(1280, 720)
        StartScreenTab.setStyleSheet(u"QWidget{\n"
...
"}")
        ...
        self.help.setPixmap(QPixmap(u":/images/images/Help_Icon.svg"))
        ...
        self.logo.setPixmap(QPixmap(u":/images/images/cc_logo_write.png"))
        ...
        self.create_new_project.setStyleSheet(u"QPushButton {\n"
"	min-height: 80px;\n"
"}")
        icon = QIcon()
        ...
        self.open_project.setStyleSheet(u"QPushButton {\n"
"	min-height: 80px;\n"
"}")
        icon1 = QIcon()
        icon1.addFile(u":/images/images/open_icon_white.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.import_project.setObjectName(u"import_project")
        self.import_project.setFont(font)
        self.import_project.setStyleSheet(u"QPushButton {\n"
"	min-height: 80px;\n"
"}")
        icon2 = QIcon()
        icon2.addFile(u":/images/images/import_icon_white.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
