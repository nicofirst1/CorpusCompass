...
################################################################################
## Form generated from reading UI file 'annotation_format_table_tab.ui'
##
...
"}")
        ...
        self.widget_annotformat_tablecontainer.setObjectName(u"widget_annotformat_tablecontainer")
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.widget_annotformat_tablecontainer.sizePolicy().hasHeightForWidth())
        ...
        self.label_annotformat_heading.setObjectName(u"label_annotformat_heading")
        font = QFont()
...
"}")
        ...
        self.tableWidget_annotformats = QTableWidget(self.widget_annotformat_tablecontainer)
        ...
        self.tableWidget_annotformats.setObjectName(u"tableWidget_annotformats")
        sizePolicy2 = QSizePolicy(QSizePolicy.Policy.Ignored, QSizePolicy.Policy.Fixed)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.tableWidget_annotformats.sizePolicy().hasHeightForWidth())
        ...
        self.tableWidget_annotformats.setStyleSheet(u"QAbstractItemView::indicator{\n"
"	width: 20px;\n"
"	height: 20px;\n"
"}\n"
"\n"
...
"")
        ...
        self.tableWidget_annotformats.setHorizontalScrollBarPolicy(Qt.ScrollBarAlwaysOff)
        self.tableWidget_annotformats.setSizeAdjustPolicy(QAbstractScrollArea.AdjustToContents)
        ...
        self.tableWidget_annotformats.horizontalHeader().setCascadingSectionResizes(False)
        ...
        self.label_annotformat_description = QLabel(self.widget_annotformat_tablecontainer)
        self.label_annotformat_description.setObjectName(u"label_annotformat_description")
        font4 = QFont()
        ...
        self.widget_addedit.setObjectName(u"widget_addedit")
        ...
        self.btn_annotformat_addnew.setObjectName(u"btn_annotformat_addnew")
        sizePolicy3 = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Fixed)
        sizePolicy3.setHorizontalStretch(0)
        sizePolicy3.setVerticalStretch(0)
        sizePolicy3.setHeightForWidth(self.btn_annotformat_addnew.sizePolicy().hasHeightForWidth())
        ...
        self.btn_annotformat_addnew.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        self.btn_annotformat_addnew.setStyleSheet(u"")
        icon1 = QIcon()
        icon1.addFile(u":/images/images/Plus_Icon.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.btn_annotformat_edit.setObjectName(u"btn_annotformat_edit")
        self.btn_annotformat_edit.setFont(font5)
        self.btn_annotformat_edit.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        icon2 = QIcon()
        icon2.addFile(u":/images/images/edit_icon_white.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.verticalLayout.addWidget(self.widget_annotformat_tablecontainer, 0, Qt.AlignTop)

        self.widget_annotformat_buttoncontainer = QWidget(AnnotationFormatTableTab)
        self.widget_annotformat_buttoncontainer.setObjectName(u"widget_annotformat_buttoncontainer")
        sizePolicy3.setHeightForWidth(self.widget_annotformat_buttoncontainer.sizePolicy().hasHeightForWidth())
        ...
        self.btn_annotformat_cancel = QPushButton(self.widget_annotformat_buttoncontainer)
        self.btn_annotformat_cancel.setObjectName(u"btn_annotformat_cancel")
        self.btn_annotformat_cancel.setFont(font5)
        self.btn_annotformat_cancel.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        self.btn_annotformat_cancel.setStyleSheet(u"QPushButton {\n"
"	color: white;\n"
...
"}")
        ...
        self.btn_annotformat_save.setObjectName(u"btn_annotformat_save")
        self.btn_annotformat_save.setEnabled(True)
        sizePolicy4 = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Preferred)
        sizePolicy4.setHorizontalStretch(0)
        sizePolicy4.setVerticalStretch(0)
        sizePolicy4.setHeightForWidth(self.btn_annotformat_save.sizePolicy().hasHeightForWidth())
        self.btn_annotformat_save.setSizePolicy(sizePolicy4)
        font6 = QFont()
        font6.setPointSize(16)
        font6.setBold(True)
        self.btn_annotformat_save.setFont(font6)
        self.btn_annotformat_save.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        self.btn_annotformat_save.setLayoutDirection(Qt.LeftToRight)
        self.btn_annotformat_save.setStyleSheet(u"QPushButton {\n"
"	color: white;\n"
...
"}")
    ...
    def retranslateUi(self, AnnotationFormatTableTab):
        self.label_annotformat_heading.setText(QCoreApplication.translate("AnnotationFormatTableTab", u"Specify Annotation Fromat", None))
        self.btn_help.setText(QCoreApplication.translate("AnnotationFormatTableTab", u"Help...", None))
        ...
        self.label_annotformat_description.setText(QCoreApplication.translate("AnnotationFormatTableTab", u"Overview of your specified annotation formats for the current project. Each annotation in your pre-annotated corpus that matches the pattern of one of the specified annotation format will be detected and further processed. In this menu, annotation formats can be added, edited, and deleted so that CorpusCompass can detect all annotations for your individual annotation style.", None))
        self.btn_annotformat_addnew.setText(QCoreApplication.translate("AnnotationFormatTableTab", u"Add annotation format", None))
        self.btn_annotformat_edit.setText(QCoreApplication.translate("AnnotationFormatTableTab", u"Edit annotation format", None))
        self.btn_annotformat_cancel.setText(QCoreApplication.translate("AnnotationFormatTableTab", u"Cancel", None))
        self.btn_annotformat_save.setText(QCoreApplication.translate("AnnotationFormatTableTab", u"Save changes", None))
        pass
    # retranslateUi
