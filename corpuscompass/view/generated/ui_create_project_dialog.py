...
class Ui_CreateProjectDialog(object):
    def setupUi(self, CreateProjectDialog):
        ...
        icon = QIcon()
        icon.addFile(":/images/images/cc_logo_sd.png", QSize(), QIcon.Normal, QIcon.Off)
        CreateProjectDialog.setWindowIcon(icon)
        CreateProjectDialog.setStyleSheet(
            "QWidget{\n"
        ...
        self.proj_name_lineedit.setObjectName("proj_name_lineedit")
        ...
        self.textEdit_createproject_description.setObjectName(
            "textEdit_createproject_description"
        )
        ...
        self.groupBox_preannotated.setObjectName("groupBox_preannotated")
        ...
        self.radioButton_corpuspreannot.setObjectName("radioButton_corpuspreannot")
        ...
        self.radioButton_corpusnotannot.setObjectName("radioButton_corpusnotannot")
        ...
        self.groupBox_annottechnique.setObjectName("groupBox_annottechnique")
        ...
        self.radioButton_symbolbasedannot.setObjectName("radioButton_symbolbasedannot")
        ...
        self.radioButton_colorbasedannot.setObjectName("radioButton_colorbasedannot")
        ...
        self.error_message_label.setStyleSheet("QLabel { color : red; }")
        ...
        QWidget.setTabOrder(
            self.proj_name_lineedit, self.textEdit_createproject_description
        )
        QWidget.setTabOrder(
            self.textEdit_createproject_description, self.radioButton_corpuspreannot
        )
        QWidget.setTabOrder(
            self.radioButton_corpuspreannot, self.radioButton_symbolbasedannot
        )
        QWidget.setTabOrder(
            self.radioButton_symbolbasedannot, self.radioButton_colorbasedannot
        )
        QWidget.setTabOrder(
            self.radioButton_colorbasedannot, self.radioButton_corpusnotannot
        )
        ...
        self.radioButton_corpuspreannot.toggled.connect(
            self.groupBox_annottechnique.setEnabled
        )
        self.radioButton_corpusnotannot.clicked["bool"].connect(
            self.groupBox_annottechnique.setDisabled
        )
    ...
    def retranslateUi(self, CreateProjectDialog):
        CreateProjectDialog.setWindowTitle(
            QCoreApplication.translate(
                "CreateProjectDialog", "Create new Project", None
            )
        )
        self.label_description.setText(
            QCoreApplication.translate("CreateProjectDialog", "Description", None)
        )
        self.label_name.setText(
            QCoreApplication.translate("CreateProjectDialog", "Name", None)
        )
        self.groupBox_preannotated.setTitle(
            QCoreApplication.translate("CreateProjectDialog", "Corpus settings", None)
        )
        self.radioButton_corpuspreannot.setText(
            QCoreApplication.translate(
                "CreateProjectDialog", "Corpus already fully annotated", None
            )
        )
        self.radioButton_corpusnotannot.setText(
            QCoreApplication.translate(
                "CreateProjectDialog", "Corpus not yet annotated", None
            )
        )
        self.groupBox_annottechnique.setTitle(
            QCoreApplication.translate(
                "CreateProjectDialog", "Used annotation-technique", None
            )
        )
        self.radioButton_symbolbasedannot.setText(
            QCoreApplication.translate("CreateProjectDialog", "Symbol-Based", None)
        )
        self.radioButton_colorbasedannot.setText(
            QCoreApplication.translate(
                "CreateProjectDialog", "Color/Highlighting-Based", None
            )
        )
