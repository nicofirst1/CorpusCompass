...
################################################################################
## Form generated from reading UI file 'project_information_dialog.ui'
##
...
"}")
        icon = QIcon()
        icon.addFile(u":/images/images/edit_icon.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"}")
        icon1 = QIcon()
        icon1.addFile(u":/images/images/export_icon.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
