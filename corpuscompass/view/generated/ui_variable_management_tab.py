...
################################################################################
## Form generated from reading UI file 'variable_management_tab.ui'
##
...
"\n"
"QPushButton:default {\n"
"    border-color: navy; /* make t"
                        "he default button prominent */\n"
"}")
...
"}")
        icon1 = QIcon()
        icon1.addFile(u":/images/images/edit_icon_white.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"}")
        icon2 = QIcon()
        icon2.addFile(u":/images/images/Help_Icon.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
