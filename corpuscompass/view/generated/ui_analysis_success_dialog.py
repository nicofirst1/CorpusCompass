...
################################################################################
## Form generated from reading UI file 'analysis_success_dialog.ui'
##
...
class Ui_AnalysisSuccessDialog(object):
    def setupUi(self, AnalysisSuccessDialog):
        if not AnalysisSuccessDialog.objectName():
            AnalysisSuccessDialog.setObjectName(u"AnalysisSuccessDialog")
        ...
        self.widget_text.setObjectName(u"widget_text")
        ...
        self.label_filepath_description.setObjectName(u"label_filepath_description")
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Maximum, QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_filepath_description.sizePolicy().hasHeightForWidth())
        ...
        self.btn_savelocation.setObjectName(u"btn_savelocation")
    ...
    def retranslateUi(self, AnalysisSuccessDialog):
        AnalysisSuccessDialog.setWindowTitle(QCoreApplication.translate("AnalysisSuccessDialog", u"Dialog", None))
        self.label_header.setText(QCoreApplication.translate("AnalysisSuccessDialog", u"Analysis: Success!", None))
        self.label_explanation.setText(QCoreApplication.translate("AnalysisSuccessDialog", u"CorpusCompass was able to analyse your corpus with all your parameters! CorpusCompass has created output files that contain the data of your analysis. These results are saved as CSV-Files (use Microsoft Excel to open). Please select the specific location where you want to save the files!", None))
        self.label_filepath_description.setText(QCoreApplication.translate("AnalysisSuccessDialog", u"Selected File-Path:", None))
        self.label_filepath.setText(QCoreApplication.translate("AnalysisSuccessDialog", u"C: ...", None))
        self.btn_savelocation.setText(QCoreApplication.translate("AnalysisSuccessDialog", u"Select save location...", None))
        self.btn_save.setText(QCoreApplication.translate("AnalysisSuccessDialog", u"Save...", None))
    # retranslateUi
