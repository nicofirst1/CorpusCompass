...
################################################################################
## Form generated from reading UI file 'dv_editor_dialog.ui'
##
...
class Ui_DVEditorDialog(object):
    def setupUi(self, DVEditorDialog):
        if not DVEditorDialog.objectName():
            DVEditorDialog.setObjectName(u"DVEditorDialog")
        ...
        self.comboBox_selectdv.setObjectName(u"comboBox_selectdv")
        sizePolicy2 = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Fixed)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.comboBox_selectdv.sizePolicy().hasHeightForWidth())
        self.comboBox_selectdv.setSizePolicy(sizePolicy2)
        self.comboBox_selectdv.setMinimumSize(QSize(119, 25))
        self.comboBox_selectdv.setStyleSheet(u"QComboBox {\n"
...
"")
        ...
        self.label_selectdv.setObjectName(u"label_selectdv")
        font1 = QFont()
        ...
        self.btn_delete_dv.setObjectName(u"btn_delete_dv")
        self.btn_delete_dv.setEnabled(False)
        sizePolicy3 = QSizePolicy(QSizePolicy.Policy.Maximum, QSizePolicy.Policy.Fixed)
        sizePolicy3.setHorizontalStretch(0)
        sizePolicy3.setVerticalStretch(0)
        sizePolicy3.setHeightForWidth(self.btn_delete_dv.sizePolicy().hasHeightForWidth())
        self.btn_delete_dv.setSizePolicy(sizePolicy3)
        self.btn_delete_dv.setMinimumSize(QSize(25, 25))
        self.btn_delete_dv.setStyleSheet(u"QPushButton {\n"
...
"}")
        icon = QIcon()
        icon.addFile(u":/images/images/trash_icon.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.label_dvname.setObjectName(u"label_dvname")
        sizePolicy4 = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Maximum)
        sizePolicy4.setHorizontalStretch(0)
        sizePolicy4.setVerticalStretch(0)
        sizePolicy4.setHeightForWidth(self.label_dvname.sizePolicy().hasHeightForWidth())
        ...
        self.horizontalLayout.addWidget(self.label_variableinputwarning, 0, Qt.AlignRight)
        ...
        sizePolicy5.setHeightForWidth(self.lineEdit_nameinput.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy3.setHeightForWidth(self.btn_editconfirm.sizePolicy().hasHeightForWidth())
...
"}")
        icon1 = QIcon()
        icon1.addFile(u":/images/images/checked_icon.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.checkBox_showonlycurrentvariants.setObjectName(u"checkBox_showonlycurrentvariants")
        self.checkBox_showonlycurrentvariants.setEnabled(False)
        self.checkBox_showonlycurrentvariants.setChecked(True)

        self.verticalLayout_2.addWidget(self.checkBox_showonlycurrentvariants, 0, Qt.AlignTop)
        ...
        self.lineEdit_searchvariants.setObjectName(u"lineEdit_searchvariants")
        sizePolicy6 = QSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Fixed)
        sizePolicy6.setHorizontalStretch(0)
        sizePolicy6.setVerticalStretch(0)
        sizePolicy6.setHeightForWidth(self.lineEdit_searchvariants.sizePolicy().hasHeightForWidth())
        ...
        self.tableWidget_dialog_dvaddvariants.setHorizontalHeaderItem(0, __qtablewidgetitem)
        font4 = QFont()
        ...
        self.tableWidget_dialog_dvaddvariants.setHorizontalHeaderItem(1, __qtablewidgetitem1)
        __qtablewidgetitem2 = QTableWidgetItem()
        __qtablewidgetitem2.setFont(font3);
        self.tableWidget_dialog_dvaddvariants.setHorizontalHeaderItem(2, __qtablewidgetitem2)
        self.tableWidget_dialog_dvaddvariants.setObjectName(u"tableWidget_dialog_dvaddvariants")
        ...
        sizePolicy7.setHeightForWidth(self.tableWidget_dialog_dvaddvariants.sizePolicy().hasHeightForWidth())
        ...
        self.tableWidget_dialog_dvaddvariants.setStyleSheet(u"QAbstractItemView::indicator{\n"
"	width: 20px;\n"
"	height: 20px;\n"
"	margin-left: 20px;\n"
"}\n"
...
"")
        ...
        self.tableWidget_dialog_dvaddvariants.setVerticalScrollBarPolicy(Qt.ScrollBarAsNeeded)
        self.tableWidget_dialog_dvaddvariants.setHorizontalScrollBarPolicy(Qt.ScrollBarAlwaysOff)
        self.tableWidget_dialog_dvaddvariants.setSizeAdjustPolicy(QAbstractScrollArea.AdjustToContentsOnFirstShow)
        self.tableWidget_dialog_dvaddvariants.setEditTriggers(QAbstractItemView.NoEditTriggers)
        ...
        self.tableWidget_dialog_dvaddvariants.setSelectionMode(QAbstractItemView.NoSelection)
        ...
        self.tableWidget_dialog_dvaddvariants.horizontalHeader().setCascadingSectionResizes(False)
        self.tableWidget_dialog_dvaddvariants.horizontalHeader().setMinimumSectionSize(0)
        self.tableWidget_dialog_dvaddvariants.horizontalHeader().setDefaultSectionSize(200)
        self.tableWidget_dialog_dvaddvariants.horizontalHeader().setProperty(u"showSortIndicator", True)
        self.tableWidget_dialog_dvaddvariants.horizontalHeader().setStretchLastSection(True)
    ...
    def retranslateUi(self, DVEditorDialog):
        DVEditorDialog.setWindowTitle(QCoreApplication.translate("DVEditorDialog", u"Dialog", None))
        self.label_header.setText(QCoreApplication.translate("DVEditorDialog", u"Dependent Variable - Editor", None))
        self.comboBox_selectdv.setCurrentText("")
        self.comboBox_selectdv.setPlaceholderText(QCoreApplication.translate("DVEditorDialog", u"Select Dependent Variable...", None))
        self.label_selectdv.setText(QCoreApplication.translate("DVEditorDialog", u"Select Dependent Variable to edit:", None))
        self.btn_delete_dv.setText("")
        self.label_dvname.setText(QCoreApplication.translate("DVEditorDialog", u"Change name (confirm with button on the right):", None))
        self.label_variableinputwarning.setText("")
        self.lineEdit_nameinput.setPlaceholderText(QCoreApplication.translate("DVEditorDialog", u"Select DV above...", None))
#if QT_CONFIG(tooltip)
        self.btn_editconfirm.setToolTip(QCoreApplication.translate("DVEditorDialog", u"<html><head/><body><p>Confirm changes</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.btn_editconfirm.setText("")
        self.label.setText(QCoreApplication.translate("DVEditorDialog", u"Tick variants that should be grouped to the selected DV:", None))
        self.groupBox_filter.setTitle(QCoreApplication.translate("DVEditorDialog", u"Filter", None))
        self.checkBox_showonlycurrentvariants.setText(QCoreApplication.translate("DVEditorDialog", u"Only show Variants that belong to the current DV", None))
        self.checkBox_unassociated_dvs.setText(QCoreApplication.translate("DVEditorDialog", u"Only show Variants that are not associated to a DV yet", None))
        self.lineEdit_searchvariants.setPlaceholderText(QCoreApplication.translate("DVEditorDialog", u"Search by name...", None))
        ___qtablewidgetitem = self.tableWidget_dialog_dvaddvariants.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("DVEditorDialog", u"Variant", None));
        ___qtablewidgetitem1 = self.tableWidget_dialog_dvaddvariants.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("DVEditorDialog", u"Add", None));
        ___qtablewidgetitem2 = self.tableWidget_dialog_dvaddvariants.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("DVEditorDialog", u"Set Color", None));
    # retranslateUi
