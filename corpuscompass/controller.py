...
class Controller(QObject):
    ...
    def __init__(self, model: CorpusCompassModel, view: CorpusCompassView) -> None:
        ...
        # Set up the callbacks for the tabs
        self.view.home_menu_tab.set_controller_callback(lambda: self)
        self.view.speaker_tab.set_controller_callback(lambda: self)
        self.view.annotation_format_tab.set_controller_callback(lambda: self)
        self.view.variable_management_tab.set_controller_callback(lambda: self)
        self.view.load_files_tab.set_controller_callback(lambda: self)
        self.view.analysis_settings_tab.set_controller_callback(lambda: self)
