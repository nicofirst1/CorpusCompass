...
class GetProjectDataTestCase(unittest.TestCase):
    ...
    def test_getting_dv(self):
        ...
        project.add_dv_value(
            "Other_DV_Value", "green"
        )  # This value should not be included in the output as it is not assigned to any DV
    ...
    def test_getting_dv_values(self):
        ...
        file = File(
            ...
            "./virtual_file.txt",
            1.0,
            "Speaker A: Hey, [$how.ENG_Word] are you? Speaker B: I'm fine thanks, what about you? Speaker C: Mir gehts gut, [$danke.GER_Word].",
        )
        ...
        expected_output = {
            "GER_Word": (1, "Language", "red"),
            "ENG_Word": (1, "Language", "blue"),
            "OTHER": (0, None, "green"),
        }
        self.assertEqual(output, expected_output)
